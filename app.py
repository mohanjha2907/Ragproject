...
.hero-title {
    ...
    line-height: 1.1;
    margin: 0;
    background: linear-gradient(135deg, #1a1a2e 0%, var(--accent) 50%, var(--accent-2) 100%);
...
.badge-purple { background: rgba(124,58,237,0.12); color: var(--accent); border: 1px solid rgba(124,58,237,0.25); }
.badge-cyan   { background: rgba(8,145,178,0.10); color: var(--accent-2); border: 1px solid rgba(8,145,178,0.25); }
.badge-green  { background: rgba(5,150,105,0.10); color: var(--success); border: 1px solid rgba(5,150,105,0.25); }
...
.dot-active   { background: var(--accent); box-shadow: 0 0 8px var(--accent-glow); animation: pulse 1.5s infinite; }
...
.chat-container, .chat-container * { color: var(--text); }
...
# ─── Sidebar ────────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('<div class="hero-title" style="font-size:1.6rem">🧠 ClipMind</div>', unsafe_allow_html=True)
...
# ─── Main Area ──────────────────────────────────────────────────────────────────
st.markdown('<div class="hero-title">🧠 ClipMind</div>', unsafe_allow_html=True)
        ...
        for msg in st.session_state.chat_history:
            if msg["role"] == "user":
                ...
                <div class="chat-msg" style="align-items:flex-start">
                    <span class="chat-label bot-label">🧠 ClipMind</span>
...
st.markdown("---")
st.markdown("""
<div style="text-align:center;padding:1rem 0 2rem;color:var(--text-muted);font-size:0.8rem">
    Managed by <strong style="color:var(--text)">Mohan Kumar Jha</strong> &nbsp;·&nbsp;
    <a href="mailto:mohanjha0705@gmail.com" style="color:var(--accent);text-decoration:none">mohanjha0705@gmail.com</a>
</div>""", unsafe_allow_html=True)